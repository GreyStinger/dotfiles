...

{
  programs.zathura = {
    ...
    options = {
      ...
      notification-error-fg = "#${config.colorScheme.palette.base08}"; # bright:red
      notification-warning-bg = "#${config.colorScheme.palette.base00}"; # bg
      notification-warning-fg = "#${config.colorScheme.palette.base0A}"; # bright:yellow
      ...
      completion-highlight-bg = "#${config.colorScheme.palette.base0D}"; # bright:blue
      ...
      highlight-active-color = "#${config.colorScheme.palette.base09}"; # bright:orange
